...
export default function Filter({ isOpen }: FilterProps) {
  ...
  return (
    <div className={filterClass}>
      ...
      <ul>
        <li>
          <label htmlFor="filter-1">Genre</label>
          <datalist id="filter-1-1" className="border-secondary">
            <option></option>
        ...
        <li>
          <label htmlFor="filter-2">Year</label>
          <input type="text" id="filter-2-1" />
        </li>
        <li>
          <label htmlFor="filter-3">Author</label>
          <input type="text" id="filter-3-1" />
        </li>
        <li>
          <label htmlFor="filter-4">Type</label>
          <datalist>
            <option></option>
